...
<!-- Mirrored from blogzine.webestica.com/404.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:28:25 GMT -->
<head>
						...
						<ul class="dropdown-menu" aria-labelledby="postMenu">
							...
							<li class="dropdown-submenu dropend"> 
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									...
									<li> <a class="dropdown-item" href="post-large-and-grid.php">Post mixed large then grid</a> </li>
								</ul>
							</li>
...
<section class="overflow-hidden">
	<div class="container">
      ...
      <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
        ...
        <a href="../index.php" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Back to home page</a>
      </div>
    </div>
	</div>
</section>
