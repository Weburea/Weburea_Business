...
<!-- Mirrored from blogzine.webestica.com/docs/avatar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:45 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					...
					<div class="my-5">
						<h1>Avatar</h1>
            	<p class="lead">Examples for choosing different size of image classes for an Avatar (also known as a profile picture or userpic)</p>
						<hr class="my-5">
					</div>
<!-- Page content START -->

<h3 class="mt-5">Avatar</h3>
<!-- Tab START -->
...
<code class="language-markup" data-lang="html">&lt;div class="avatar"&gt;
	&lt;img class="avatar-img rounded-circle" src="assets/images/avatar/01.jpg" alt="avatar"&gt;
&lt;/div&gt;
&lt;div class="avatar"&gt;
	&lt;img class="avatar-img rounded-circle" src="assets/images/avatar/02.jpg" alt="avatar"&gt;
...
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-5">
			...
			<div class="avatar">
				<div class="avatar-img rounded-circle bg-dark-soft"><span class="text-dark position-absolute top-50 start-50 translate-middle fw-bold">W</span></div>
			</div>
...
<!-- Tab START -->
<h3 class="mt-5">Avatar Styles</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-7">
		...
		<div class="avatar align-middle">
			<img class="avatar-img rounded-3" src="assets/images/avatar/06.jpg" alt="avatar">
		</div>
		<div class="avatar align-middle">
...
<code class="language-markup" data-lang="html">&lt;div class="avatar align-middle"&gt;
	&lt;img class="avatar-img" src="assets/images/avatar/01.jpg" alt="avatar"&gt;
&lt;/div&gt;
&lt;div class="avatar align-middle"&gt;
	&lt;div class="avatar-img bg-primary"&gt;&lt;span class="text-white position-absolute top-50 start-50 translate-middle fw-bold"&gt;SL&lt;/span&gt;&lt;/div&gt;
...
<code class="language-markup" data-lang="html">&lt;div class="avatar avatar-xs"&gt;
	&lt;img class="avatar-img rounded-circle" src="assets/images/avatar/01.jpg" alt="avatar"&gt;
&lt;/div&gt;
&lt;div class="avatar avatar-sm"&gt;
	&lt;img class="avatar-img rounded-circle" src="assets/images/avatar/02.jpg" alt="avatar"&gt;
...
<!-- Mirrored from blogzine.webestica.com/docs/avatar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:50 GMT -->
</html>
