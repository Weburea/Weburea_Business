...
<!-- Mirrored from blogzine.webestica.com/docs/breadcrumb.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:50 GMT -->
<head>
...
<code class="language-markup" data-lang="html">&lt;nav aria-label="breadcrumb"&gt;
  &lt;ol class="breadcrumb"&gt;
    &lt;li class="breadcrumb-item active" aria-current="page"&gt;Home&lt;/li&gt;
  &lt;/ol&gt;
&lt;/nav&gt;
...
<!-- Alerts Examples -->
<h3 class="mt-5">Examples dark</h3>
<p>Use the <code>.breadcrumb-dark</code> class to quickly change dark breadcrumb</p>
...
<code class="language-markup" data-lang="html">&lt;nav style="--bs-breadcrumb-divider: '&gt;';" aria-label="breadcrumb"&gt;
	&lt;ol class="breadcrumb"&gt;
		&lt;li class="breadcrumb-item"&gt;&lt;a href="#"&gt;Home&lt;/a&gt;&lt;/li&gt;
		&lt;li class="breadcrumb-item active" aria-current="page"&gt;Library&lt;/li&gt;
	&lt;/ol&gt;
...
<!-- breadcrumb-less -->
<p>You can also remove the divider setting <code>--bs-breadcrumb-divider: '';</code> (empty strings in CSS custom properties counts as a value), or setting the Sass variable to <code>$breadcrumb-divider: none;</code>.</p>
...
<h3 class="mt-5">Breadcrumb dots</h3>
<p>Add <code>.breadcrumb-dots</code> to enable dot separator style for a breadcrumb.</p>
