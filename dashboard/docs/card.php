...
<!-- Mirrored from blogzine.webestica.com/docs/card.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:50 GMT -->
<head>
	...
	<div class="tab-pane show active" id="tab-1">
		<div class="col-6">	
			<div class="card" style="width: 18rem;">
			  <img src="assets/images/blog/4by3/06.jpg" class="card-img-top" alt="...">
			  <div class="card-body">
...
<code class="language-markup" data-lang="html">&lt;div class="card" style="width: 18rem;"&gt;
...
<!-- Tab END -->
<hr class="mt-5">
<p class="lead my-5"> As blogzine is a blog and magazine-based theme we have used cards to display posts almost everywhere in theme. With the help of utility classes, we have designed many ready-to-use cards.</p>

<!-- Card with background image Examples -->
<h3 class="mt-5">Card with background image</h3>
...
<code class="language-markup" data-lang="html">&lt;div class="card card-overlay-bottom card-grid-lg card-bg-scale h-500" style="background-image:url(assets/images/blog/4by3/06.jpg); background-position: center left; background-size: cover;"&gt;
	&lt;!-- Card featured --&gt;
	&lt;span class="card-featured" title="Featured post"&gt;&lt;i class="fas fa-star"&gt;&lt;/i&gt;&lt;/span&gt;
	&lt;!-- Card Image overlay --&gt;
	&lt;div class="card-img-overlay d-flex align-items-center p-3 p-sm-4"&gt; 
...
<h3 class="mt-5">Card with image tag</h3>
<ul class="nav nav-tabs nav-tabs-line">
	<li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#tab-31">Result</a> </li>
	<li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#tab-41">HTML</a> </li>
</ul>
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-31">
		<div class="col-md-5">
			<div class="card card-overlay-bottom card-img-scale">
				...
				<div class="card-img-overlay d-flex flex-column p-3 p-sm-4">
						<div>
							<!-- Card category -->
							<a href="#" class="badge bg-dark mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Travel</a>
						</div>
					<div class="w-100 mt-auto">
						<!-- Card title -->
...
<code class="language-markup" data-lang="html">&lt;div class="card card-overlay-bottom card-img-scale"&gt;
	&lt;!-- Card Image --&gt;
	&lt;img class="card-img h-200" src="assets/images/blog/4by3/06.jpg" alt=""&gt;
	&lt;!-- Card Image overlay --&gt;
	&lt;div class="card-img-overlay d-flex flex-column p-3 p-sm-4"&gt;
...
<!-- Card with image and content Examples -->
<h3 class="mt-5">Card with image and content</h3>
...
<div class="position-relative">
<pre id="copy-32" class="my-3">
<code class="language-markup" data-lang="html">&lt;div class="card bg-transparent"&gt;
	&lt;!-- Card img --&gt;
	&lt;div class="position-relative"&gt;
		&lt;img class="card-img" src="assets/images/blog/4by3/06.jpg" alt="Card image"&gt;
		&lt;div class="card-img-overlay d-flex align-items-start flex-column p-3"&gt;
...
<button id="copy_id-32" data-clipboard-action="copy" data-clipboard-target="#copy-32" class="copy-link btn btn-primary btn-sm">Copy</button>
</div>
</div>
</div>
<!-- Tab END -->
...
<h3 class="mt-5">Card Horizontal</h3>
...
<code class="language-markup" data-lang="html">&lt;div class="card bg-transparent mb-4"&gt;
	&lt;div class="row"&gt;
		&lt;div class="col-md-5"&gt;
			&lt;img class="rounded-3" src="assets/images/blog/4by3/06.jpg" alt=""&gt;
		&lt;/div&gt;
...
<!-- List card with content Examples -->
<h3 class="mt-5">Card list</h3>
<ul class="nav nav-tabs nav-tabs-line">
		...
		<div class="card border rounded-3 up-hover p-4 mb-4">
			<div class="row g-3">
				...
				<div class="col-md-6 col-lg-3">
					<img class="rounded-3" src="assets/images/blog/4by3/06.jpg" alt="Card image">
				</div>
			</div>
		</div>
		<!-- Card item END -->
...
<code class="language-markup" data-lang="html">&lt;div class="card border rounded-3 up-hover p-4 mb-4"&gt;
	&lt;div class="row g-3"&gt;
		&lt;div class="col-lg-5"&gt;
			&lt;!-- Categories --&gt;
...
<!--  Card with video popup Examples -->
<h3 class="mt-5">Card with video popup</h3>
<p>To make video popup work you must include Glightbox CSS and Javascript file on the page.</p>
<ul class="nav nav-tabs nav-tabs-line">
				...
				<div class="card-img-overlay d-flex flex-column p-3 p-sm-5">
					...
					<div class="w-100 mt-auto">
						<div class="col text-center">
							<!-- Card category -->
							<a href="#" class="badge text-bg-warning mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Business</a>
							<!-- Card title -->
...
<code class="language-markup" data-lang="html">&lt;div class="col-6"&gt;
	&lt;div class="card card-overlay-bottom card-fold h-400 h-lg-540" style="background-image:url(assets/images/blog/4by3/06.jpg); background-position: center left; background-size: cover;"&gt;
		&lt;!-- Card featured --&gt;
		&lt;span class="card-featured" title="Featured post"&gt;&lt;i class="fas fa-star"&gt;&lt;/i&gt;&lt;/span&gt;
		&lt;!-- Card Image overlay --&gt;
...
<!-- Card fold Examples -->
<h3 class="mt-5">Card fold</h3>
<p>Use <code>.card-fold</code> class with card or card image to enable paper fold style on hover</p>
<ul class="nav nav-tabs nav-tabs-line">
...
<code class="language-markup" data-lang="html">&lt;div class="card border rounded-3 p-4 mb-4"&gt;
	&lt;!-- Card item START --&gt;
...
<!-- Card with botton image Examples -->
<h3 class="mt-5">Card with bottom image</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-23">
		<div class="col-md-5">
			<div class="card card-fold bg-white">
...
<code class="language-markup" data-lang="html">&lt;div class="card card-fold bg-light"&gt;
	&lt;div class="card-body p-4"&gt;
		&lt;ul class="nav nav-divider align-items-center d-none d-sm-inline-block small mb-2"&gt;
			&lt;li class="nav-item"&gt;&lt;i class="bi bi-clock-history"&gt;&lt;/i&gt; 56:36&lt;/li&gt;
			&lt;li class="nav-item"&gt;With &lt;a href="#"&gt;Larry Lawson&lt;/a&gt; &lt;/li&gt;
...
<!-- Card with only content Examples -->
<h3 class="mt-5">Card with only content</h3>
<ul class="nav nav-tabs nav-tabs-line">
	...
	<div class="tab-pane show active" id="tab-19">
		<div class="card">
			<div class="card-body p-4 border rounded-3">	
				<a href="#" class="badge text-bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
				<h4 class="card-title"><a href="#" class="btn-link text-reset fw-bold">12 worst types of business accounts you follow on Twitter</a></h4>
...
<code class="language-markup" data-lang="html">&lt;div class="card mb-4"&gt;
	&lt;div class="card-body p-4 border rounded-3"&gt;	
...
<!-- Bottom-border Card with only content Examples -->
<h3 class="mt-5">Bottom-border Card with only content</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<code class="language-markup" data-lang="html">&lt;div class="card mb-1"&gt;
	&lt;div class="card-body px-0 border-bottom"&gt;
		&lt;a href="#" class="badge bg-dark mb-2"&gt;&lt;i class="fas fa-circle me-2 small fw-bold"&gt;&lt;/i&gt;Technology&lt;/a&gt;
		&lt;h5&gt;&lt;a href="#" class="btn-link stretched-link text-dark fw-bold"&gt;Around the web: 20 fabulous infographics about business&lt;/a&gt;&lt;/h5&gt;
		&lt;!-- Card info --&gt;
...
<!-- Card with gird Examples -->
<h3 class="mt-5">Card custom gird</h3>
<p>We have created a card custom size with fixed heights. Card height can be change from  <code>assets/scss/custom/card.scss</code> file.</p>
...
<code class="language-markup" data-lang="html">&lt;div class="row g-4 card-grid"&gt;
   &lt;!-- Left big card --&gt;
   &lt;div class="col-lg-6"&gt;
      &lt;div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url(assets/images/blog/4by3/06.jpg); background-position: center left; background-size: cover;"&gt;
         &lt;!-- Card featured --&gt;
...
<p class="mt-5">For more information refer <a href="https://getbootstrap.com/docs/5.0/components/card/">official Bootstrap documentation</a> for detailed technical explanation.</p>
<!-- Page content END -->	
				</div>
			</div>
		</div>
...
<!-- Mirrored from blogzine.webestica.com/docs/card.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:53 GMT -->
</html>
