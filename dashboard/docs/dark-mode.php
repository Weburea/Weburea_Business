...
<!-- Mirrored from blogzine.webestica.com/docs/dark-mode.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:42 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					...
					<div class="my-5">
						<h1>Dark mode</h1>
            	<p class="lead">How to work with dark mode?</p>
						<hr class="my-5">
					</div>

<!-- Page content START -->
<h4>Dark mode switch (Toggle)</h4>
<p class="mb-4">Dark mode switcher is enabled by default. If you don't want switcher you just need to remove switcher code from all HTML files. See switcher code example below:</pclass>


<h5 class="mt-5">Dark mode button with dropdown</h5>
<!-- Tab START -->
	...
	<code class="language-markup" data-lang="html">&lt;!-- Dark mode options START --&gt;
...
<h5 class="mt-5">Dark mode icon with dropdown</h5>
<!-- Tab START -->
<ul class="nav nav-tabs nav-tabs-line">
...
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-3">
		...
		<div class="dropdown d-inline-block me-2">
			<a href="#" class="text-warning mb-0" id="bd-theme"
			aria-expanded="false"
...
&lt;div class="dropdown me-2"&gt;
	...
	data-bs-toggle="dropdown"
	data-bs-display="static"&gt;
		&lt;svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-circle-half grayscale theme-icon-active fa-fw" viewBox="0 0 16 16"&gt;
			&lt;path d="M8 15A7 7 0 1 0 8 1v14zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16z"/&gt;
			&lt;use href="#"&gt;&lt;/use&gt;
		&lt;/svg&gt;
	&lt;/a&gt;
...
<h5 class="mt-5">Dark mode inline buttons</h5>
<!-- Tab START -->
	<ul class="nav nav-tabs nav-tabs-line">
	...
	<div class="tab-content bg-dark p-4">
...
<h5 class="mt-5">Only dark mode</h5>
<p>If you prefer only dark mode in your theme:</p>
<ol>
  <li>Add below attribute in your <code>html</code> tag in all HTML files.
<pre>
<code class="language-markup" data-lang="html">&lt;html lang="en" data-bs-theme="dark"&gt;
</code></pre>
  </li>
  <li>Remove darkmode script from head tag.</li>
</ol>


<h5 class="mt-5">Only light mode (Remove dark mode)</h5>
<p>To remove dark mode from theme, follow below steps:</p>
<ol>
  <li>Add below line in <code>_user-variables.scss</code> file while running gulp.
<pre><code class="language-markup" data-lang="html">$enable-dark-mode:            false; </code></pre></li>
  <li>Remove switcher code from all HTML files</li>
  <li>Remove darkmode script from head tag. (Optional but recommended)</li>
</ol>
<p><span class="badge bg-danger me-2">Note:</span> If you are not working with gulp, you can skip 1st step..</p>
</p>

<h5 class="mt-5">Dark mode customization</h5>
<h6 class="mt-4">Modify Dark colors using SCSS</h6>
<p>You can find all the variables used to create the dark mode in <code>assets/scss/_dark-mode.scss</code> file. If you want to override a variable, copy that variable to your <code>assets/scss/_user.scss</code> file and update it as per your need. When you change the variable with scss, make sure that the <a href="gulp.php">gulp</a> is running.</p>
<p><span class="badge bg-danger me-2">Note:</span>Sometimes brand primary colors do not readable in dark mode, so we have provided option to set different primary colors for dark mode. To change dark mode primary color go to <code>_user.scss</code> file and follow the instruction in the same file.</p>

<h6 class="mt-4">Modify Dark colors using CSS</h6>
<p>You can find all the CSS variables used to create the dark mode in <code>assets/css/style.css</code> file. Look for the selector <code>data-bs-theme="dark"</code> and you will see all the available variables. If you want to override a variable, copy that variable to your <code>custom.css</code> file and update it as per your need.</p>

<h6>Dark mode items</h6>
<p>You can show or hide any elements in dark or light mode. Use <code>.light-mode-item</code> for elements that you want to show in light mode only. Use<code>.dark-mode-item</code> for elements that you want to show in dark mode only. See below example that we have used for theme logo.</p>
<pre>
<code class="language-markup" data-lang="html">&lt;img class="light-mode-item" src="assets/images/logo.svg" alt="logo"&gt;
