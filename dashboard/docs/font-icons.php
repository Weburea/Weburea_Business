...
<!-- Mirrored from blogzine.webestica.com/docs/font-icons.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:53 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					...
					<div class="my-5">
						<h1>Font icons</h1>
            			<p class="lead">Retina-ready font icons with a very modern touch that will beautifully compliment your project.</p>
						<hr class="my-5">
					</div>
<!-- Page content START -->

<p>We have included <a href="https://fontawesome.com/icons?d=gallery&amp;m=free" target="_blank">Font awesome</a> and <a href="https://icons.getbootstrap.com/" target="_blank">Bootstrap Icons</a> fonts in Blogzine theme.</p>
<h5>Font awesome:</h5>
	<p>You can place Font Awesome icons just about anywhere using a style prefix and the icon’s name. To reference an icon, you need to know two bits of information.</p>
	<ol class="mb-4">
		<li>Its name, prefixed with <code class="inline">fa-</code> (meaning “font awesome” naturally!)</li>
...
<p class="mt-3">A complete list of Font awesome icons along with the class names can be<a href="https://fontawesome.com/icons?d=gallery&amp;m=free" target="_blank"> found here</a></p>


<h5 class="mt-5">Bootstrap Icons:</h5>
	<p>You can place Bootstrap Icons just about anywhere using icon's name. See below example code:</p>
<pre>
<code class="language-markup">
&lt;i class="bi bi-alarm-fill"&gt;&lt;/i&gt;
</code>
</pre>
<p class="mt-3">A complete list of Bootstrap icons along with the class names can be <a href="https://icons.getbootstrap.com/" target="_blank">found here</a></p>
<!-- Tab END -->
