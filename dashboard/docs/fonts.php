...
<!-- Mirrored from blogzine.webestica.com/docs/fonts.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:42 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					...
					<div class="my-5">
						<h1>Fonts</h1>
            			<p class="lead">Learn how to change site fonts</p>
						<hr class="my-5">
					</div>
<!-- Page content START -->
...
<!-- Page content START -->
<p>By default, theme uses Google fonts. In case, If you want to change font to any other Google fonts, Please have a look in the head part of the webpage and you will find this tag:</p>
...
<p>After changing fonts you need to update font families in <code>_variables.scss</code> or override in <code>_user-variables.scss</code> file </p>

<pre><code class="language-markup">// Font Families

$font-family-base:           'Rubik', sans-serif;
$headings-font-family:        'Nunito Sans', sans-serif;
</code></pre>

<p class="mt-4">If you want to use custom fonts, remove above section completely and visit <a href="http://css-tricks.com/snippets/css/using-font-face/" target="_blank">Self Hosted Fonts</a></p>
