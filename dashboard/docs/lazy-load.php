...
<!-- Mirrored from blogzine.webestica.com/docs/lazy-load.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:26 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					...
					<div class="my-5">
						<h1>Lazy load</h1>
            	<p class="lead">Speeds up your web application with lazy load</p>
						<hr class="my-5">
					</div>

<!-- Page content START -->
<p>We have implemented lazy load demo on <a href="../index-lazy.html" target="_blank">index-lazy.html</a> page only. As, not every developer/user wants lazy load. You can set lazy load in your webpage as per your need. Follow below Introduction to enable lazy load.</p>


<h6 class="mt-4">Add Required JS</h6>
<pre class="my-3">
<code class="language-markup" data-lang="html">&lt;script src="assets/vendor/vanilla-lazyload/lazyload.min.js"&gt;&lt;/script&gt;
</code></pre>

<p  class="mt-5">In order to make your content be loaded by LazyLoad, you must use some <code>data-</code> attributes instead of the actual attributes along with <code>.lazy</code> class. Examples below.</p>
<h6 class="mt-4">Lazy image</h6>
<pre class="my-3">
<code class="language-markup" data-lang="html">&lt;img class="lazy" data-src="assets/images/blog/4by3/03.jpg" alt="Image"&gt;
</code></pre>

<h6 class="mt-4">Lazy image with low quality placeholder:
</h6>
<pre class="my-3">
<code class="language-markup" data-lang="html">&lt;img class="lazy" data-src="assets/images/blog/4by3/03.jpg" src="lowQualityImage.jpg" alt="Image"&gt;
</code></pre>


<h6 class="mt-4">Lazy background image:</h6>
<pre class="my-3">
<code class="language-markup" data-lang="html">&lt;div class="lazy" data-bg="assets/images/blog/1by1/02.jpg" style="background-position: center left; background-size: cover;"&gt;&lt;/div&gt;
</code></pre>


<p class="mt-5">Visit plugin <a href="https://github.com/verlok/vanilla-lazyload" target="_blank">Vanilla lazyload on	Github </a> for full documentation</p>
...
<!-- Mirrored from blogzine.webestica.com/docs/lazy-load.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:27 GMT -->
</html>
