...
<!-- Mirrored from blogzine.webestica.com/docs/page-loading.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:42 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					<!-- Page title -->
					<div class="my-5">
						<h1>Page Loading (Pre-Loader)</h1>
            <p class="lead">How to add pre-loading page animation.</p>
						<hr class="my-5">
					</div>
<!-- Page content START -->
<p class="mt-2">Page Pre-loader is disabled by default. If you wish to enable the page pre-loader you can simply add below code right after body tag start in all HTML files. </p>
<div class="position-relative">
<pre id="copy-2" class="my-3">
<code class="language-markup">&lt;!-- Pre loader --&gt;
&lt;div class="preloader"&gt;
