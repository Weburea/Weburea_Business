...
<!-- Mirrored from blogzine.webestica.com/docs/pagination.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:53 GMT -->
<head>
...
<code class="language-markup" data-lang="html">&lt;nav aria-label="Page navigation example"&gt;
 &lt;ul class="pagination"&gt;
    &lt;li class="page-item"&gt;&lt;a class="page-link" href="#"&gt;Previous&lt;/a&gt;&lt;/li&gt;
    &lt;li class="page-item"&gt;&lt;a class="page-link" href="#"&gt;1&lt;/a&gt;&lt;/li&gt;
    &lt;li class="page-item"&gt;&lt;a class="page-link" href="#"&gt;2&lt;/a&gt;&lt;/li&gt;
...
<!-- Working with icons Examples -->
<h3 class="mt-5">Working with icons</h3>
...
<code class="language-markup" data-lang="html">&lt;div class="col-12"&gt;
	&lt;h5 class="text-center"&gt;Pagination sm&lt;/h5&gt;
	&lt;nav class="mb-5" aria-label="navigation"&gt;
	  &lt;ul class="pagination pagination-sm d-inline-block d-md-flex justify-content-center"&gt;
	    &lt;li class="page-item disabled"&gt;
...
<!-- Border pagination Examples -->
<h3 class="mt-5">Bordered pagination</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<!-- Jump pagination Examples -->
<h3 class="mt-5">Jump pagination</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<div class="position-relative">
<pre id="copy-22" class="my-3">
<code class="language-markup" data-lang="html">&lt;nav class="mb-5 d-lg-flex justify-content-between" aria-label="navigation"&gt;
  &lt;!-- Pagination 1 2 3  --&gt;
  &lt;ul class="pagination pagination-bordered justify-content-center d-inline-block d-lg-flex"&gt;
    &lt;li class="page-item"&gt;
      &lt;a class="page-link" href="#"&gt;First&lt;/a&gt;
...
<button id="copy_id-22" data-clipboard-action="copy" data-clipboard-target="#copy-22" class="copy-link btn btn-primary btn-sm">Copy</button>
</div>
</div>
</div>
<!-- Tab END -->

<!-- Full-width pagination Examples -->
<h3 class="mt-5">Full width pagination</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<code class="language-markup" data-lang="html">&lt;nav class="my-5" aria-label="navigation"&gt;
	&lt;ul class="pagination pagination-bordered d-flex justify-content-between"&gt;
		&lt;li&gt;
			&lt;ul class="list-unstyled"&gt;
				&lt;li class="page-item"&gt;
...
<!-- Newer Older Pagination Examples -->
<h3 class="mt-5">Newer Older Pagination</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<code class="language-markup" data-lang="html">&lt;nav class="mt-5" aria-label="navigation"&gt;
    &lt;ul class="pagination d-flex justify-content-between"&gt;
      &lt;li class="page-item flex-fill text-center"&gt;
        &lt;a href="#" class="page-link"&gt; &lt;i class="fas fa-long-arrow-alt-left me-2 rtl-flip"&gt;&lt;/i&gt; Older&lt;/a&gt;
      &lt;/li&gt;
...
<!--  Load more button Pagination Examples -->
<h3 class="mt-5">Load more button Pagination</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<code class="language-markup" data-lang="html">&lt;div class="col-12 text-center mt-5"&gt;
	&lt;button type="button" class="btn btn-primary-soft"&gt;Load more post &lt;i class="bi bi-arrow-down-circle align-middle ms-2"&gt;&lt;/i&	gt;&lt;/button&gt;
&lt;/div&gt;
&lt;div class="col-12 text-center mt-3"&gt;
	&lt;button type="button" class="btn btn-primary-soft w-100"&gt;Load more post &lt;i class="bi bi-arrow-down-circle ms-2 align-middle"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;
...
<!--  Alignment Pagination Examples -->
<h3 class="mt-5">Alignment</h3>
<p>Change the alignment of pagination components with <a href="#">flexbox utilities</a>.</p>
<ul class="nav nav-tabs nav-tabs-line">
