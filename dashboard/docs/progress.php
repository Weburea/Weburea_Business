...
<!-- Mirrored from blogzine.webestica.com/docs/progress.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:53 GMT -->
<head>
...
<p>Progress components are built with two HTML elements, some CSS to set the width, and a few attributes. We don't use the <a href="#">HTML5 &lt;progress&gt; element</a>, ensuring you can stack progress bars, animate them, and place text labels over them.</p>
...
<code class="language-markup" data-lang="html">&lt;div class="progress"&gt;
&lt;div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"&gt;&lt;/div&gt;
&lt;/div&gt;
&lt;div class="progress mt-3"&gt;
  &lt;div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"&gt;&lt;/div&gt;
...
<code class="language-markup" data-lang="html">&lt;div class="progress mt-3" style="height: 1px;"&gt;
  &lt;div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"&gt;&lt;/div&gt;
&lt;/div&gt;
&lt;div class="progress mt-3" style="height: 20px;"&gt;
  &lt;div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"&gt;&lt;/div&gt;
...
<!-- Multiple bars Examples -->
<h3 class="mt-5">Multiple bars</h3>
...
<!-- Animated stripes -->
<h3 class="mt-5">Animated stripes</h3>
...
<h3 class="mt-5">Progress percentage style</h3>
<ul class="nav nav-tabs nav-tabs-line">
...
<div class="tab-content bg-light p-4">
	<div class="tab-pane show active" id="tab-17">
		<p class="mb-1 mt-3 text-dark">Progress percentage</p>
		<div class="progress progress-percent-bg">
...
<code class="language-markup" data-lang="html">&lt;p class="mb-1 mt-3 text-dark"&gt;Progress percentage&lt;/p&gt;
&lt;div class="progress progress-percent-bg"&gt;
  &lt;div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"&gt;&lt;span class="progress-percent"&gt;80%&lt;/span&gt;&lt;/div&gt;
&lt;/div&gt;
</code></pre>
