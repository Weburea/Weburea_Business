...
<!-- Mirrored from blogzine.webestica.com/docs/sticky-footer.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:53 GMT -->
<head>
		...
		<div class="main-content">
			<div class="row">
				<div class="col-12">
					<!-- Page title -->
					<div class="my-5">
						<h1>Sticky Footer (footer fixed)</h1>
            			<p class="lead">Sticky footer is a footer that sticks to the bottom of the page regardless of the amount of content on the page</p>
						<hr class="my-5">
					</div>
<!-- Page content START -->

<p>You can easily transform your existing footer into Sticky Footer by adding <code>.footer-sticky</code> class:</p>
<pre class="my-3">
