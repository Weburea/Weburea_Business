                    ...
                    <ul class="navbar-nav navbar-nav-scroll mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="postMenu">
                                ...
                                <li> <a class="dropdown-item" href="dashboard-post-categories.php">Post Categories</a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                                <li> <a class="dropdown-item" href="dashboard-home.php">Home Dynamic</a></li>
                                <li> <a class="dropdown-item" href="dashboard-about.php">About Dynamic</a></li>
                                <li> <a class="dropdown-item" href="dashboard-benefits.php">Benefit Page</a></li>
                                <li> <a class="dropdown-item" href="dashboard-contact.php">Contact Dynamic</a></li>
                                ...
                                <li> <a class="dropdown-item" href="https://support.webestica.com/" target="_blank"> <i
                                            class="text-warning fa-fw bi bi-life-preserver me-2"></i>Support</a></li>
                                <li> <a class="dropdown-item" href="docs/index.php" target="_blank"> <i
                                            class="text-danger fa-fw bi bi-card-text me-2"></i>Documentation</a></li>
                                <li class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="rtl/index.php" target="_blank"> <i
                                            class="text-info fa-fw bi bi-toggle-off me-2"></i>RTL demo</a></li>
                                <li><a class="dropdown-item" href="https://themes.getbootstrap.com/store/webestica/"
                                        target="_blank"> <i
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <a class="h6 mt-2 mt-sm-0" href="#"> Weburea Admin</a>
                                        <p class="small m-0">admin@weburea.com</p>
                                    </div>
                                </div>
                                <hr>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="signin.php?logout=1"><i
                                        class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
                            <li class="dropdown-divider mb-2"></li>
                            <li>
                                <div class="align-items-center text-center py-0">
                                    <span class="me-3 text-secondary small">mode:</span>
