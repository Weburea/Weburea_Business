...
<!-- Mirrored from blogzine.webestica.com/pagination-styles.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:19 GMT -->
<head>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 mx-auto text-center">
				<h1 class="display-6">Pagination styles</h1>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center mb-5">Default pagination</h3>
			</div>
			<div class="col-12">
...
<hr class="m-0">
<!-- =======================
Bordered pagination START -->
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center mb-5">Bordered pagination</h3>
			</div>
			<div class="col-12">
...
<!-- =======================
Bordered Pagination END -->

<hr class="m-0">
<!-- Jump pagination START -->
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center mb-5">Jump pagination</h3>
			</div>
			<nav class="mb-5 d-lg-flex justify-content-between" aria-label="navigation">
			  <!-- Pagination 1 2 3  -->
...
<hr class="m-0">
<!-- =======================
Full width pagination START -->
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center">Full width pagination</h3>
			</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center">Newer Older Pagination</h3>
			</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h3 class="text-center">Load more button Pagination</h3>
			</div>
