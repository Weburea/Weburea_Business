...
<!-- Mirrored from blogzine.webestica.com/post-large-and-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:16 GMT -->
<head>
...
<section class="pt-4">
	<div class="container">
		<div class="row">
      <div class="col-12">
				<h1 class="display-5">Post grid large than grid</h1>
			...
			<div class="col-lg-9">
                ...
                <!-- Card featured -->
					      <span class="card-featured" title="Featured post"><i class="fas fa-star"></i></span>
							...
							<div class="card-body px-0 pt-3">
								<h2 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">12 worst types of business accounts you follow on Twitter</a></h2>
					...
					<div class="col-sm-6">
						<div class="card">
							...
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Dirty little secrets about the business industry</a></h4>
					...
					<div class="col-sm-6">
						<div class="card">
							...
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Bad habits that people in the industry need to quit</a></h4>
					...
					<div class="col-sm-6">
						<div class="card">
							...
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Around the web: 20 fabulous infographics about business</a></h4>
					...
					<div class="col-sm-6">
						<div class="card">
							...
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">7 common mistakes everyone makes while traveling</a></h4>
					...
					<div class="col-sm-6">
						<div class="card">
							...
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">5 investment doubts you should clarify</a></h4>
						...
						<div class="card">
							...
							<div class="position-relative">
								...
								<div class="card-img-overlay d-flex align-items-start flex-column p-3">
									...
									<div class="w-100 mt-auto">
										<!-- Card category -->
										<a href="#" class="badge bg-success mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Covid-19</a>
									</div>
								</div>
							</div>
							<div class="card-body px-0 pt-3">
								<h4 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">5 intermediate guide to business</a></h4>
								<p class="card-text">Luckily cheered colonel I do we attack highest enabled. Tried law yet style child. The bore of true of no be deal. Was out laughter raptures returned outweigh. </p>
								<!-- Card info -->
								<ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
									<li class="nav-item">
										<div class="nav-link">
				...
				<div data-sticky data-margin-top="80" data-sticky-for="767">
					...
					<div>
						...
						<div class="text-center mt-3">
							<a href="#" class="fw-bold text-body-secondary text-primary-hover"><u>View all categories</u></a>
						</div>
					</div>
						...
						<div class="col-12 col-sm-6 col-lg-12">
							...
							<div class="card mb-3">
								<div class="row g-3">
									...
									<div class="col-8">
										<h6><a href="post-single-2.php" class="btn-link stretched-link text-reset fw-bold">The pros and cons of business agency</a></h6>
							...
							<div class="card mb-3">
								<div class="row g-3">
									...
									<div class="col-8">
										<h6><a href="post-single-2.php" class="btn-link stretched-link text-reset fw-bold">5 reasons why you shouldn't startup</a></h6>
							...
							<div class="card mb-3">
								<div class="row g-3">
									...
									<div class="col-8">
										<h6><a href="post-single-2.php" class="btn-link stretched-link text-reset fw-bold">Ten questions you should answer truthfully.</a></h6>
							...
							<div class="card mb-3">
								<div class="row g-3">
									...
									<div class="col-8">
										<h6><a href="post-single-2.php" class="btn-link stretched-link text-reset fw-bold">Five unbelievable facts about money.</a></h6>
