...
<!-- Mirrored from blogzine.webestica.com/post-overlay.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:16 GMT -->
<head>
				...
				<div class="card card-overlay-bottom h-300 overflow-hidden text-center" style="background-image:url(assets/images/blog/16by9/08.jpg); background-position: center left; background-size: cover;">
					...
					<div class="card-img-overlay d-flex align-items-center p-3 pb-4 px-sm-5"> 
						<div class="col-12 mt-auto d-md-flex justify-content-between align-items-center">
							<h1 class="text-white display-5">Post overlay</h1>
	...
	<div class="container">
		<div class="row g-4">
					...
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								...
								<a href="#" class="badge bg-primary mb-2"><i class="fas fa-circle me-2"></i>Travel</a>
								<!-- Card title -->
								<h2 class="text-white display-6"><a href="post-single-4.php" class="btn-link text-reset stretched-link fw-normal">This is why this year will be the year of startups</a></h2>
								<!-- Card info -->
			...
			<div class="col-md-6">
				<div class="card card-overlay-bottom card-img-scale">
					<!-- Card Image -->
					<img class="card-img" src="assets/images/blog/4by3/15.jpg" alt="">
					<!-- Card Image overlay -->
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								<!-- Card category -->
								<a href="#" class="badge text-bg-info mb-2"><i class="fas fa-circle me-2"></i>Covid-19</a>
								<!-- Card title -->
								<h2 class="text-white display-6"><a href="post-single-4.php" class="btn-link text-reset stretched-link fw-normal">Business ideas that will boom in upcoming years</a></h2>
								<!-- Card info -->
								<ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
									<li class="nav-item">
										<div class="nav-link">
									...
									<li class="nav-item">Mar 16, 2022</li>
									<li class="nav-item">
										<a href="#" class="btn-link"><i class="fas fa-comment-alt me-1"></i> 15 Comments</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-6">
				<div class="card card-overlay-bottom card-img-scale">
					<!-- Card Image -->
					<img class="card-img" src="assets/images/blog/4by3/14.jpg" alt="">
					<!-- Card Image overlay -->
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								<!-- Card category -->
								<a href="#" class="badge text-bg-danger mb-2"><i class="fas fa-circle me-2"></i>Business</a>
								<!-- Card title -->
								<h2 class="text-white display-6"><a href="post-single-4.php" class="btn-link text-reset stretched-link fw-normal">8 initial problem of startups and their solution</a></h2>
								<!-- Card info -->
								<ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
									<li class="nav-item">
										<div class="nav-link">
									...
									<li class="nav-item">Apr 03, 2022</li>
									<li class="nav-item">
										<a href="#" class="btn-link"><i class="fas fa-comment-alt me-1"></i> 0 Comments</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-6">
				<div class="card card-overlay-bottom card-img-scale">
					<!-- Card Image -->
					<img class="card-img" src="assets/images/blog/4by3/13.jpg" alt="">
					<!-- Card Image overlay -->
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								<!-- Card category -->
								<a href="#" class="badge text-bg-warning mb-2"><i class="fas fa-circle me-2"></i>Technology</a>
								<!-- Card title -->
								<h2 class="text-white display-6"><a href="post-single-4.php" class="btn-link text-reset stretched-link fw-normal">Best Pinterest Boards for learning about business</a></h2>
								<!-- Card info -->
								<ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
									<li class="nav-item">
										<div class="nav-link">
									...
									<li class="nav-item">
										<a href="#" class="btn-link"><i class="fas fa-comment-alt me-1"></i> 3 Comments</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-6">
				<div class="card card-overlay-bottom card-img-scale">
					<!-- Card Image -->
					<img class="card-img" src="assets/images/blog/4by3/11.jpg" alt="">
					<!-- Card Image overlay -->
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								...
								<ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
									...
									<li class="nav-item">May 26, 2022</li>
									<li class="nav-item">
										<a href="#" class="btn-link"><i class="fas fa-comment-alt me-1"></i> 1 Comments</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-6">
				<div class="card card-overlay-bottom card-img-scale">
					<!-- Card Image -->
					<img class="card-img" src="assets/images/blog/4by3/10.jpg" alt="">
					<!-- Card Image overlay -->
					<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
						<div class="w-100 mt-auto">
							<div class="col">
								<!-- Card category -->
								<a href="#" class="badge bg-dark mb-2"><i class="fas fa-circle me-2"></i>Startups</a>
								<!-- Card title -->
								<h2 class="text-white display-6"><a href="post-single-4.php" class="btn-link text-reset stretched-link fw-normal">Best Pinterest Boards for learning about business</a></h2>
								<!-- Card info -->
								<ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
									...
									<li class="nav-item">Dec 03, 2022</li>
									<li class="nav-item">
										<a href="#" class="btn-link"><i class="fas fa-comment-alt me-1"></i> 6 Comments</a>
									</li>
								</ul>
							</div>
						</div>
