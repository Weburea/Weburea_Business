...
<!-- Mirrored from blogzine.webestica.com/post-single-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:18 GMT -->
<head>
...
<section id="item-1" class="pb-3 pb-lg-5">
	<div class="container">
        ...
        <a href="#" class="badge bg-primary bg-opacity-10 text-primary mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Review</a>
				...
				<div id="item-5">
					<div class="border p-3 p-md-5 rounded mb-3">
						...
						<div class="d-flex mt-4">
							<div class="me-3">
								<div class="icon-xl rounded-circle bg-primary bg-opacity-10 text-primary">8.5</div>
							</div>
					...
					<div class="tiny-slider arrow-hover arrow-dark arrow-round">
						<div class="tiny-slider-inner"
							...
							<div class="card">
								...
								<div class="card-body px-0 pt-3">
									<h5 class="card-title"><a href="post-single-6.php" class="btn-link text-reset fw-bold">7 common mistakes everyone makes while traveling</a></h5>
									<!-- Card info -->
							...
							<div class="card">
								...
								<div class="position-relative">
									...
									<div class="card-img-overlay d-flex align-items-start flex-column p-3">
										...
										<div class="w-100 mb-auto d-flex justify-content-end">
											<div class="text-end ms-auto">
												<!-- Card format icon -->
												<div class="icon-md text-bg-warning fw-bold rounded-circle" title="5.2 rating">5.2</div>
											</div>
										</div>
										<!-- Card overlay bottom -->
										<div class="w-100 mt-auto">
								...
								<div class="card-body px-0 pt-3">
									<h5 class="card-title"><a href="post-single-6.php" class="btn-link text-reset fw-bold">Skills that you can learn from business</a></h5>
									<!-- Card info -->
									<ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
										<li class="nav-item">
											<div class="nav-link">
							...
							<div class="card">
								...
								<div class="position-relative">
									...
									<div class="card-img-overlay d-flex align-items-start flex-column p-3">
										...
										<div class="w-100 mb-auto d-flex justify-content-end">
											<div class="text-end ms-auto">
												<!-- Card format icon -->
												<div class="icon-md text-bg-danger fw-bold rounded-circle" title="2.5 rating">2.5</div>
											</div>
										</div>
										<!-- Card overlay bottom -->
										<div class="w-100 mt-auto">
								...
								<div class="card-body px-0 pt-3">
									<h5 class="card-title"><a href="post-single-6.php" class="btn-link text-reset fw-bold">10 tell-tale signs you need to get a new business</a></h5>
									<!-- Card info -->
									<ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
										<li class="nav-item">
											<div class="nav-link">
