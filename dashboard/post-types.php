...
<!-- Mirrored from blogzine.webestica.com/post-types.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:16 GMT -->
<head>
				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="homeMenu">
							...
							<li> <a class="dropdown-item" href="../index.php">Magazine classic</a></li>
							<li> <a class="dropdown-item" href="../index.php">Magazine</a></li>
							<li> <a class="dropdown-item" href="../index.php">Home cards</a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog classic</a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog Personal </a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog Vintage</a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog Tech</a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog Fashion</a></li>
							<li> <a class="dropdown-item" href="../index.php">Blog Podcast</a></li>
							<li> <a class="dropdown-item" href="../index.php">Home Shop </a></li>
						</ul>
					</li>
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							...
							<li class="dropdown-submenu dropend"> 
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="shop-grid.php">Shop grid</a> </li>
									<li> <a class="dropdown-item" href="shop-detail.php">Shop detail</a> </li>
									<li> <a class="dropdown-item" href="checkout.php">Checkout</a> </li>
									<li> <a class="dropdown-item" href="my-cart.php">Cart</a> </li>
							...
							<li class="dropdown-divider"></li>
							<li> 
								<a class="dropdown-item" href="rtl/index.php" target="_blank">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="postMenu">
							...
							<li class="dropdown-submenu dropend"> 
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="post-grid.php">Post grid</a> </li>
									<li> <a class="dropdown-item" href="post-grid-4-col.php">Post grid 4 col</a> </li>
									<li> <a class="dropdown-item" href="post-grid-masonry.php">Post grid masonry</a> </li>
									<li> <a class="dropdown-item" href="post-grid-masonry-filter.php">Post grid masonry filter</a> </li>
									<li> <a class="dropdown-item" href="post-large-and-grid.php">Post mixed large than grid</a> </li>
								</ul>
							</li>
							<li> <a class="dropdown-item" href="post-list.php">Post list</a> </li>
							<li> <a class="dropdown-item" href="post-list-2.php">Post list 2</a> </li>
							<li> <a class="dropdown-item" href="post-cards.php">Post card</a> </li>
							<li> <a class="dropdown-item" href="post-overlay.php">Post Overlay</a> </li>
							<li> <a class="dropdown-item" href="post-types.php">Post types</a> </li>
							<li class="dropdown-divider"></li>
							<li> <a class="dropdown-item" href="post-single.php">Post single magazine</a> </li>
							<li> <a class="dropdown-item" href="post-single-2.php">Post single classic</a> </li>
							<li> <a class="dropdown-item" href="post-single-3.php">Post single minimal</a> </li>
							<li> <a class="dropdown-item" href="post-single-4.php">Post single card</a> </li>
							<li> <a class="dropdown-item" href="post-single-5.php">Post single review</a> </li>
							<li> <a class="dropdown-item" href="post-single-6.php">Post single video</a> </li>
							<li> <a class="dropdown-item" href="podcast-single.php">Podcast single</a> </li>
							<li class="dropdown-divider"></li>
...
<section>
	<div class="container">
      ...
      <div class="col-md-9 mx-auto text-center">
        <h1 class="display-4">Post types</h1>
        <div class="alert alert-warning" role="alert"> Some video/audio can work only on the real server. For the correct operation of all functions, check with localhost server or upload your website on a real server.</div>
      </div>
    </div>
	</div>
</section>
...
<section class="pt-4">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6">
        ...
        <div class="card">
          ...
          <div class="card-image">
            <img class="card-img" src="assets/images/blog/16by9/05.jpg" alt="">
            </div>
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Image post</a></h5>
            <p>Drawings offended yet answered Jennings perceive laughing six did far was out laughter raptures.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              ...
              <li class="nav-item">Mar 02, 2022</li>
            </ul>
          </div>
        </div>
        <!-- Card item END -->
        ...
        <div class="card">
          <div class="ratio ratio-16x9">
            <div class="row g-0"> 
              <div class="col-6">
                <!-- Card grid image 1 -->
                <div class="h-100 me-3 rounded-3" style="background-image: url(assets/images/blog/1by1/01.jpg); background-size: cover;">
                </div>
              </div>
              <div class="col-6">
                <div class="vstack gap-3 h-100">
                  <!-- Card grid image 2 -->
                  <div class="h-50 rounded-3" style="background-image: url(assets/images/blog/16by9/01.jpg); background-size: cover;">
                  </div>
                  <!-- Card grid image 3 -->
                  <div class="h-50 rounded-3 bg-dark-overlay-4 overflow-hidden" style="background-image: url(assets/images/blog/16by9/06.jpg); background-size: cover;">
                    <div class="d-flex justify-content-center align-items-center h-100">
                      <a class="btn-link text-white mb-0 stretched-link" href="#"> View all </a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body px-0 pt-3">
            <!-- Card Title -->
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Image grid post</a></h5>
            ...
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              ...
              <li class="nav-item">Apr 10, 2022</li>
            </ul>
          </div>
        </div>
        <!-- Card item END -->
      ...
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card bg-primary h-400">
          <!-- Card Image overlay -->
              ...
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
                  <div class="d-flex align-items-center position-relative">
                    ...
                    <span class="ms-3">by <a href="#" class="stretched-link text-reset btn-link">Amanda</a></span>
                  </div>
                </li>
                <li class="nav-item">Jan 10, 2022</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <!-- Background video post START -->
      <div class="col-md-6">
        <div class="card card-overlay-bottom bg-parallax h-400" data-jarallax-video="https://youtu.be/WS-MfCjzztg" data-speed="1.2">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4">
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.php" class="btn-link text-reset stretched-link">Background video post</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
      ...
      <div class="col-md-6">
        ...
        <div class="card">
            ...
            <div class="tiny-slider dots-inside dots-white">
              <div class="tiny-slider-inner" data-arrow="false" data-dots="true" data-autoplay="true" data-items="1" data-gutter="0">
                <div class="overflow-hidden">
                  <img class="card-img" src="assets/images/blog/16by9/06.jpg" alt="Post">
                </div>
                <div class="overflow-hidden">
                  <img class="card-img" src="assets/images/blog/16by9/08.jpg" alt="Post">
                </div>
              </div>
            </div>
            <!-- Slider END -->
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Image slider post</a></h5>
      ...
      <!-- YouTube video post (ratio 16x9) embedded iframe START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <!-- Video image -->
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">YouTube video post (ratio 16x9) embedded iframe</a></h5>
            <p>Morning unto Don't can't air Shall fruit life made fly darkness she'd seasons tree made living.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
              ...
              <li class="nav-item">June 25, 2022</li>
            </ul>
          </div>
        </div>
        <!-- Card item END -->
      </div>
      <!-- YouTube video post (ratio 16x9) embedded iframe END -->


      <!-- Vimeo video post (ratio 16x9) embedded iframe START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <div class="card-image">
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Vimeo video post (ratio 16x9) embedded iframe</a></h5>
            <p>Beginning day behold gathering day earth Very hath shall very abundantly face midst called isn't green.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
              ...
              <li class="nav-item">Feb 14, 2022</li>
            </ul>
          </div>
        </div>
        <!-- Card item END -->
      </div>
      <!-- Vimeo video post (ratio 16x9) embedded iframe END -->
       ...
       <!-- Card item START -->
				<div class="card bg-transparent">
					...
					<div class="position-relative">
						<img class="rounded" src="assets/images/blog/16by9/small/01.jpg" alt="Card image">
						<div class="card-img-overlay d-flex align-items-start flex-column p-3">
							<!-- Card overlay -->
							<div class="w-100 my-auto">
								<!-- Popup video -->
								<a href="https://youtu.be/n_Cn8eFo7u8" class="icon-md bg-primary d-block mx-auto text-white rounded-circle stretched-link" data-glightbox data-gallery="y-video">
					...
					<div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Popup video post</a></h5>
            <p>Give And fruit moving thing seed life day creepeth winged so divide him from day morning.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
                  <div class="d-flex align-items-center position-relative">
                    ...
                    <span class="ms-3">by <a href="#" class="stretched-link text-reset btn-link">Brayn</a></span>
                  </div>
                </div>
              </li>
      ...
      <hr>
      <!-- Plyr plugin video audio post -->
      <h3>Plyr plugin video and audio post options</h3>
      ...
      <div class="col-md-6">
        ...
        <div class="card">
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">HTML5 player video post</a></h5>
            <p>He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
      ...
      <div class="col-md-6">
        ...
        <div class="card">
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Player youtube post</a></h5>
            <p>He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
      ...
      <!-- Player youtube post END -->


      <!-- Player vimeo post START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <!-- Video -->
              ...
              <div class="overflow-hidden w-100">
                ...
                <div class="player-wrapper rounded-3 overflow-hidden">
                  <div class="player-vimeo" >
                    <iframe src="https://player.vimeo.com/video/225888984?h=65630c41c6"></iframe>
                  </div>
                </div>
                <!-- HTML video END -->
              </div>
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Player vimeo post</a></h5>
            <p>He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
      ...
      <!-- Player vimeo post END -->

      <!-- Audio player post START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <div class="card-image">
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Audio player post</a></h5>
            <p>Night Said you open Evening him And make thing one their midst the face under bearing.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
              ...
              <li class="nav-item">Wed 10, 2022</li>
            </ul>
          </div>
        </div>
        <!-- Card item END -->
      </div>
      <!-- Audio player post END -->


      <!-- Audio player post with Background image START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <div class="card-image position-relative">
            <img class="rounded" src="assets/images/blog/16by9/small/07.jpg" alt="Card image">
            <div class="card-img-overlay d-flex align-items-start flex-column p-3">
              <!-- Card overlay -->
              <div class="w-100 my-auto">
                <!-- Audio START -->
          ...
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Audio player post with Background image</a></h5>
            <p>Under folly balls, death own point now men. Match way these she avoids seeing death. She who drift their fat off.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
                <div class="nav-link">
      ...
      <!-- Audio player post with Background image END -->


      <!-- Audio player post with Background color START -->
      <div class="col-md-6">
        <!-- Card item START -->
        <div class="card">
          <!-- Audio video START -->
          ...
          <!-- Audio video END -->
          <div class="card-body px-0 pt-3">
            <h5 class="card-title"><a href="post-single-3.php" class="btn-link text-reset fw-bold">Audio player post with Background color</a></h5>
            <p>Night Said you open Evening him And make thing one their midst the face under bearing.</p>
            <!-- Card info -->
            <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
              <li class="nav-item">
      ...
      <!-- Audio player post with Background color END -->
...
<!-- Mirrored from blogzine.webestica.com/post-types.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:29:17 GMT -->
</html>
