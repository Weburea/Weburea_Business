...
<!-- Mirrored from blogzine.webestica.com/rtl/my-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:30:50 GMT -->
<head>
							...
							<div class="row align-items-center">
								...
								<div class="col-7 col-md-10">
									<div class="row g-2">
										...
										<div class="col-md-7">
											<!-- Product detail START -->
											<h5 class="mb-1"><a href="#">Men's Watertight Jacket</a></h5>
                      <small class="text-primary">Available in 5 days</small>
											<!-- List -->
											<ul class="nav nav-divider small align-items-center mt-1">
												<li class="nav-item">Gender: Male</li>
												<li class="nav-item">Color: Yellow</li>
												<li class="nav-item">Size: L</li>
											</ul>
										</div>
			...
			<div class="col-lg-4">
				...
				<div class="card bg-light border border-secondary border-opacity-25 rounded-2 p-4">
					...
					<div class="card-footer bg-light border-top p-0 pt-3">
						...
						<!-- Button -->
						<div class="d-grid"><a href="#" class="btn btn-primary mb-0">Checkout</a></div>
					</div>
				</div>
				<!-- Order summary END -->
