...
<!-- Mirrored from blogzine.webestica.com/rtl/shop-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:30:48 GMT -->
<head>
	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu">
		...
		<div class="offcanvas-body d-flex flex-column px-3">
			...
			<div class="mt-auto">
				...
				<!-- Button -->
				<div class="d-grid">
					<a href="checkout.php" class="btn btn-lg btn-primary-soft mb-0">Continue to Checkout</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				...
				<div class="nav mt-3 mt-lg-0 px-4 flex-nowrap align-items-center">
					<div class="nav-item w-100">
						<form class="rounded position-relative">
							<input class="form-control pe-5 bg-light" type="search" placeholder="Search the products" aria-label="Search">
				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
					...
					<!-- Nav item 2 shop all -->
					<li class="nav-item"> <a class="nav-link" href="shop-grid.php">Shop all</a></li>
			...
			<div class="nav flex-nowrap align-items-center ms-3 ms-lg-4">
				...
				<div class="nav-item position-relative ms-3">
					<a class="btn btn-light btn-round mb-0" data-bs-toggle="offcanvas" href="#offcanvasMenu" role="button" aria-controls="offcanvasMenu">
							<i class="bi bi-cart3 fa-fw" data-bs-target="#offcanvasMenu"></i>
					</a>
					<span class="position-absolute top-0 start-100 translate-middle badge smaller rounded-circle bg-dark mt-xl-2 ms-n1">2 
...
<section>
	<div class="container">
		<div class="row g-4 g-lg-0 justify-content-between">
			...
			<div class="col-lg-6">
				<!-- Title -->
				<h1>AB Camera Foldable RC Drone Quadcopter</h1>
				<p class="mb-4">He moonlights difficult engrossed it, sportsmen. Interested has all Devonshire difficulty gay assistance joy. </p>
						...
						<div class="col-sm-6">
							<ul class="list-group list-group-borderless">
								...
								<li class="list-group-item pb-0">
									<span>Category:</span>
									<span class="h6 mb-0"><a href="shop-grid.php">Drone</a></span>
								</li>
							</ul>
						</div>
						<!-- List -->
				...
				<div class="mb-4">
					...
					<ul class="list-inline mt-2">
						...
						<li class="list-inline-item">
							...
							<label class="btn btn-primary-soft-check" for="option1">
								<img src="assets/images/shop/11.png" class="w-60" alt="">
							</label>
						</li>
						...
						<li class="list-inline-item">
							...
							<label class="btn btn-primary-soft-check" for="option2">
								<img src="assets/images/shop/12.png" class="w-60" alt="">
							</label>
						</li>
					</ul>
				</div>	
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<h4 class="text-success">$598.00</h4>
					</div>
					<!-- Select -->
					...
					<!-- Button -->
					<div class="col-md-6">
						<a href="#" class="btn btn-primary mb-0 w-100"><i class="bi bi-cart2 me-2"></i>Add to Cart</a>
...
<section class="pt-0 pt-lg-5">
	<div class="container">
		<div class="row g-4 justify-content-between">
			...
			<div class="col-lg-7">
				<h5>Description</h5>
				<p>As it so contrasted oh estimating instrument. Size like body someone had. Are conduct viewing boy minutes warrant the expense? Tolerably behavior may admit daughters offending her ask own. Praise effects wishes change way and any wanted. Lively use looked latter regard had. Do he it part more last in.</p>
			...
			<div class="col-lg-4">
				...
				<div class="d-flex align-items-center position-relative">
					...
					<div class="ms-3">
						<h6 class="mb-0">by <a href="#" class="stretched-link text-reset btn-link">Carolyn</a></h6>
					</div>
				</div>
				<!-- List -->
				<div class="hstack gap-3 flex-wrap mt-2 mb-4">
					<p class="mb-0"><i class="bi bi-star-fill text-warning"></i> 5.0 <span>Average Rating</span></p>
				...
				<ul class="list-group list-group-borderless">
					<li class="list-group-item py-0">
						<span>Shopping:</span>
						<span class="h6 mb-0">Free Extended International Shipping</span>
					</li>
					<li class="list-group-item pb-0">
						<span>Delivery:</span>
						<span class="h6 mb-0">Estimated between Aug 03 to Aug 20</span>
					</li>
					<li class="list-group-item pb-0">
						<span>Payment:</span>
						<img src="assets/images/icon/visa.svg" class="w-40 me-2" alt="">
						<img src="assets/images/icon/mastercard.svg" class="w-40" alt="">
					</li>
					<li class="list-group-item pb-0">
						<span>Return:</span>
						<span class="h6 mb-0">Seller does not accept returns</span>
					</li>
				</ul>
...
<section class="pt-0">
	<div class="container">
		<!-- Title -->
		<div class="mb-2">
			<h2 class="mb-0">Rating and Reviews</h2>
		</div>
			...
			<div class="col-md-4">
				<div class="bg-primary p-4 rounded-2 mb-4">
					<div class="text-center text-white">
						<!-- Info -->
						<h2 class="mb-0 text-white">4.5</h2>
				...
				<div class="row g-2 align-items-center">
					...
					<div class="col-3 col-sm-2">
						<span class="ms-auto h6 fw-light mb-0">85%</span>
					</div>
					...
					<!-- Percentage -->
					<div class="col-3 col-sm-2">
						<span class="ms-auto h6 fw-light mb-0">75%</span>
					</div>
					...
					<!-- Percentage -->
					<div class="col-3 col-sm-2">
						<span class="ms-auto h6 fw-light mb-0">60%</span>
					</div>
					...
					<!-- Percentage -->
					<div class="col-3 col-sm-2">
						<span class="ms-auto h6 fw-light mb-0">35%</span>
					</div>
					...
					<!-- Percentage -->
					<div class="col-3 col-sm-2">
						<span class="ms-auto h6 fw-light mb-0">15%</span>
					</div>
				</div> <!-- Row END -->
			...
			<div class="col-md-7">
				...
				<div class="d-flex">
					...
					<div>
						...
						<p>Warrant private blushes removed an in equally totally if. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. </p>
					...
					<div>
						<div class="d-flex justify-content-between mb-2">
							<div>
								...
								<span class="me-3 small">June 25, 2022, at 6:01 am </span>
							</div>	
							<!-- Rating Star -->
							<ul class="list-inline mb-0">
								<li class="list-inline-item small me-0"><i class="fas fa-star text-warning"></i></li>
						...
						<p>Mr feeling does chiefly cordial in do. Delivered dejection necessary objection do Mr prevailed. Mr feeling does chiefly cordial in do. </p>
						
						<span>Was it helpful?</span>
						<div class="btn-group ms-md-2" role="group" aria-label="Basic radio toggle button group">
							<!-- Yes button -->
							<input type="radio" class="btn-check" name="btnradio" id="btnradio5">
							<label class="btn btn-outline-light btn-sm mb-0" for="btnradio5"><i class="far fa-thumbs-up me-1"></i> Yes</label>
							<!-- No button -->
							<input type="radio" class="btn-check" name="btnradio" id="btnradio6">
							<label class="btn btn-outline-light btn-sm mb-0" for="btnradio6"> No <i class="far fa-thumbs-down ms-1"></i></label>
						</div>
					</div>
				</div>
				...
				<div class="tiny-slider arrow-hover arrow-dark arrow-blur arrow-round">
					...
					>
						...
						<div>
							<div class="card border p-3 h-100">
								<div class="position-relative">
									<!-- Image -->
									<a href="shop-detail.php" class="position-relative z-index-9"><img class="card-img" src="assets/images/shop/02.png" alt=""></a>
									<!-- Overlay -->
								...
								<div class="card-body text-center p-3 px-0">
									...
									<!-- Title -->
									<h5 class="card-title"><a href="shop-detail.php">Osprey Packs Backpack</a></h5>
						...
						<div>
							<div class="card border p-3 h-100">
								<!-- Image -->
								<a href="shop-detail.php"><img class="card-img" src="assets/images/shop/04.png" alt=""></a>
								...
								<div class="card-body text-center p-3 px-0">
									...
									<!-- Title -->
									<h5 class="card-title"><a href="shop-detail.php">Men's Watertight Jacket</a></h5>
						...
						<div>
							<div class="card border p-3 h-100">
								<!-- Image -->
								<a href="shop-detail.php"><img class="card-img" src="assets/images/shop/08.png" alt=""></a>
								...
								<div class="card-body text-center p-3 px-0">
									...
									<!-- Title -->
									<h5 class="card-title"><a href="shop-detail.php">Hiking Pants</a></h5>
						...
						<div>
							<div class="card border p-3 h-100">
								<!-- Image -->
								<a href="shop-detail.php"><img class="card-img" src="assets/images/shop/06.png" alt=""></a>
								...
								<div class="card-body text-center p-3 px-0">
									...
									<!-- Title -->
									<h5 class="card-title"><a href="shop-detail.php">Classic Boat Shoes</a></h5>
						...
						<div>
							<div class="card border p-3 h-100">
								<!-- Image -->
								<a href="shop-detail.php"><img class="card-img" src="assets/images/shop/07.png" alt=""></a>
								...
								<div class="card-body text-center p-3 px-0">
									...
									<!-- Title -->
									<h5 class="card-title"><a href="shop-detail.php">Backpacking Stove</a></h5>
...
<footer class="bg-dark pt-5">
	<div class="container">
		...
		<div class="row pt-3 pb-4">
			...
			<div class="col-md-5">
				<p class="text-body-secondary">The next-generation blog, news, and magazine theme for you to start sharing your stories today! This Bootstrap 5 based theme is ideal for all types of sites that deliver the news.</p>
			</div>
			<div class="col-md-4">
				<!-- Form -->
		...
		<div class="row pt-5">
			...
			<div class="col-md-6 col-lg-3 mb-4">
				...
				<div class="mb-4 position-relative">
					...
					<a href="post-single-3.php" class="btn-link text-white fw-normal">Up-coming business bloggers, you need to watch</a>
				...
				<div class="mb-4 position-relative">
					...
					<a href="post-single-3.php" class="btn-link text-white fw-normal">How did we get here? The history of the business told through tweets</a>
					<ul class="nav nav-divider align-items-center small mt-2 text-body-secondary">
						<li class="nav-item position-relative">
	...
	<div class="bg-dark-overlay-3 mt-5">
		<div class="container">
			<div class="row align-items-center justify-content-md-between py-4">
				<div class="col-md-6">
					<!-- Copyright -->
					<div class="text-center text-md-start text-primary-hover text-body-secondary">©2024 <a href="https://www.webestica.com/" class="text-reset btn-link" target="_blank">Webestica</a>. All rights reserved
					</div>
				</div>
...
<!-- Mirrored from blogzine.webestica.com/rtl/shop-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:30:50 GMT -->
</html>
