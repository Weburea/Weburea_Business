...
<!-- Mirrored from blogzine.webestica.com/tag.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 23:28:25 GMT -->
<head>
						...
						<div class="dropdown-menu" aria-labelledby="megaMenu">
							<div class="container">
								<div class="row g-4 p-3 flex-fill">
									...
									<!-- Card item START -->
									<div class="col-sm-6 col-lg-3">
										<div class="bg-primary bg-opacity-10 text-center h-100 w-100 rounded p-4">
...
<section class="pt-4">
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-md-8">
				<div class="display-1 text-primary">#business</div>
				<p>15 posts in this tag</p>
			</div>
		</div>
	</div>
</section>
			...
			<div class="col-12">
				<div class="row gy-4">
							...
							<div class="position-relative">
								...
								<div class="card-img-overlay d-flex align-items-start flex-column p-3">
									...
									<div class="w-100 mt-auto">
										<!-- Card category -->
										<a href="#" class="badge text-bg-warning mb-2"><i class="fas fa-circle small fw-bold me-2"></i>Technology</a>
									</div>
								</div>
							</div>
							<div class="card-body px-0 pt-3">
					...
					<div class="col-12 text-center mt-5">
						<button type="button" class="btn btn-primary-soft">Load more post <i class="bi bi-arrow-down-circle align-middle ms-2"></i></button>
					</div>
					<!-- Load more END -->
				</div>
			</div>
